...
def JDR(xVal1,xVal2, xn, xp, W, lifetimeN, mobilityN, lifetimeP, mobilityP,nSide, pSide, iSide, percent):
    ...
    def In1(x):
        ...
        accumulation, err = quad(intElecN,xp+W, x, limit=1000)
    ...
    def Ip1(x):
        ...
        accumulation, err = quad(intElecN, -xn, x, limit=1000)
        accumulation = mp.mpf(accumulation)
    ...
    def QIp(x):
        Q = Qp(x)
        accumulation, err = quad(intElecP, -xn, x, limit=1000)
    ...
    def n(x):
        ...
        val1 = 1/In1(x)
        xValues = np.linespace(xp+W, x, 1000)
        QIn = QIn()
        val2, err = trapz(QIn, xValues)
    ...
    def p(x):
        val1 = 1/Ip1(x)
        val2, err = quad(QIp, -xn, x,limit=1000)
