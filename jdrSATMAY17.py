...
def JDR(xVal1,xVal2, xn, xp, W, lifetimeN, mobilityN, lifetimeP, mobilityP,nSide, pSide, iSide, percent, hv, photonFlux):
    ...
    def In1(x):
        ...
        accumulation = ordered_integrate(intElecN,xVal2, x)
    ...
    def Ip1(x):
        ...
        accumulation = ordered_integrate(intElecP, x, xVal1)
    ...
    def n(x):
        ...
        val1 = 1/In1(x)
        val2 = ordered_integrate(QIn, xVal2, x)
    ...
    def p(x):
        ...
        # print(x)
        val1 = 1/Ip1(x)
        val2 = ordered_integrate(QIp, xVal1, x)
    ...
    finalCurrentElectron = maxMobilityElectrons*q*densityElectrons*ElecFieldAsXLoc(xVal1) + currentElectron
...
print(findConvergenceLifetime(9e-8, 25e-11, xn, xp, W, nSide, pSide, iSide, 0.5, 1265, 40, hv, 1e14))
...
linear_attenuation = 5.12e-2*6.15
total_width_cm = 0.0006
x_values = [0.0001, 0.0002, 0.0003, 0.0004, 0.0005]
...
for x in x_values:
    gen_rate = genDevice(x, total_width_cm, hv, float(photonFlux), E, linear_attenuation)
